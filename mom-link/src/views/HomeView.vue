...
const recommendations = computed(() => {
  ...
  if (temp > 38.5) {
    recs.push('⚠️ High fever detected - seek medical help')
  }
  if (movement <= 2) {
    recs.push('⚠️ Low fetal movement - drink cold water and rest')
  }
  if (movement === 0) {
    recs.push('⚠️ No movement detected - contact doctor immediately')
  }
  if (stress === 'High') {
    recs.push('⚠️ Try deep breathing exercises')
